...
class NYTBestSellerIntentHandler(AbstractRequestHandler):
    """Handler for NYT Best Seller Intent."""

    def can_handle(self, handler_input):
        # type: (HandlerInput) -> bool
        return ask_utils.is_intent_name("NYTBestSellerIntent")(handler_input)

    def handle(self, handler_input):
        # type: (HandlerInput) -> Response
        genre = ask_utils.request_util.get_slot_value(handler_input, "genre")
        genre_map = {
...
class HelpIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        # type: (HandlerInput) -> Response
        speak_output = "You can say best seller to know Newyork Times best seller books! How can I help?"
...
sb.add_request_handler(NYTBestSellerIntentHandler())
